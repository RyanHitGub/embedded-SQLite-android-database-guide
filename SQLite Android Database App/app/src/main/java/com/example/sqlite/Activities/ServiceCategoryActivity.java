...
public class ServiceCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<HashMap<String, String>> serviceCategoryList = dbHandler.getServiceCategories();
        ListView listView = findViewById(R.id.dbList);
        ListAdapter adapter = new SimpleAdapter(ServiceCategoryActivity.this, serviceCategoryList, R.layout.database_list_service_categories,
                new String[]{"servcatid", "servcatname", "servcatdescription"},
                new int[]{R.id.txtServCatID, R.id.txtServCatName, R.id.txtServCatDescription});
