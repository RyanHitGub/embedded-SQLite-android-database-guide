...
public class AppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<HashMap<String, String>> appointmentList = dbHandler.getAppointments();
        ListView listView = findViewById(R.id.dbList);
        ListAdapter adapter = new SimpleAdapter(AppointmentActivity.this, appointmentList, R.layout.database_list_appointment,
                new String[]{"appointmentid", "appointmentdate", "appointmenttime", "custfirstname", "custlastname",
                        "therapistfirstname", "therapistlastname", "servicedescription", "appointmentnotes"},
                new int[]{R.id.txtAppID, R.id.txtAppDate, R.id.txtAppTime, R.id.txtAppCustFirstName, R.id.txtAppCustLastName,
                        R.id.txtAppTherapistFName, R.id.txtAppTherapistLName, R.id.txtAppService, R.id.txtAppNotes});
