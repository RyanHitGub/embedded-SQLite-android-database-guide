...
public class InvoiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<HashMap<String, String>> invoiceList = dbHandler.getInvoices();
        ListView listView = findViewById(R.id.dbList);
        ListAdapter adapter = new SimpleAdapter(InvoiceActivity.this, invoiceList, R.layout.database_list_invoice,
                new String[]{"invoiceid", "invoicedate", "serviceprice", "custfirstname", "custlastname", "invoiceappointmentid"},
                new int[]{R.id.txtInvoiceID, R.id.txtInvoiceDate, R.id.txtInvoiceTotal, R.id.txtInvoiceCustomerFirstName,
                          R.id.txtInvoiceCustomerLastName, R.id.txtInvoiceAppointmentID});
