...
public class TimetableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<HashMap<String, String>> timetableList = dbHandler.getTimetables();
        ListView listView = findViewById(R.id.dbList);
        ListAdapter adapter = new SimpleAdapter(TimetableActivity.this, timetableList, R.layout.database_list_timetable,
                new String[]{"timetableid", "ttperiodbegin", "ttperiodend", "ttstarttime", "ttendtime", "therapistfirstname", "therapistlastname"},
                new int[]{R.id.txtTimetableID, R.id.txtTTPeriodBegin, R.id.txtTTPeriodEnd, R.id.txtTTStartTime,
                          R.id.txtTTEndTime, R.id.txtTTTherapistFName, R.id.txtTTTherapistLName});
